...
import com.frank.api.core.api.composite.product.ProductCompositeService;
...
public class ProductCompositeServiceApplication {
	...
	public Docket apiDocumentation() {
		...
		return new Docket(SWAGGER_2)
			.select()
			.apis(basePackage("com.frank.microservices.composite.product"))
			.paths(PathSelectors.any())
			.build()
                .globalResponseMessage(GET, emptyList())
                .tags(new Tag(ProductCompositeService.SWAGGER_TAG_PRODUT_COMPOSITE_SERVICE, 
